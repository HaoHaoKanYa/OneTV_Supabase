...
import androidx.tv.material3.darkColorScheme  // 导入用于暗色模式的颜色方案
import androidx.tv.material3.lightColorScheme  // 导入用于亮色模式的颜色方案
...
val colorSchemeForDarkMode = darkColorScheme(
    ...
    border = darkColors.outline,  // 边框颜色
    borderVariant = darkColors.outlineVariant,  // 边框变体颜色
...
val colorSchemeForLightMode = lightColorScheme(
    ...
    border = lightColors.outline,  // 边框颜色
    borderVariant = lightColors.outlineVariant,  // 边框变体颜色
